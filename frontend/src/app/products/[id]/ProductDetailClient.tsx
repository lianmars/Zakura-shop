          ...
          >
            ...
            <div className="mb-12">
              <div className="flex justify-between items-end mb-4 font-mono">
                <span className="text-[10px] uppercase tracking-[0.2em]">SELECCIONAR TALLE</span>
            ...
            <div className="space-y-6 pt-8 border-t border-white/10 font-mono">
              <div className="flex justify-between items-center group cursor-pointer">
                ...
                <span className="material-symbols-outlined text-white/50 group-hover:text-white transition-colors text-sm">add</span>
              </div>
              <div className="flex justify-between items-center group cursor-pointer">
